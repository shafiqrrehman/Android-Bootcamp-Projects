package com.shafiq.android.climateweatherapp;
...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "69a4338b437daa3fe9d0236ab18d53f7";
    ...
    protected void onResume() {
        ...
        if (city != null){
            ...
            Log.d("Clima", "Getting weather result from current location.");
    ...
    private void getWeatherForCurrentLocation() {
        ...
        mLocationListener = new LocationListener() {
            ...
            public void onProviderDisabled(String provider) {
                Log.d("Clima", "onProviderDisabled() is called.");
            }
        };
    ...
    public void updatwUI(WeatherDataModel weather) {
